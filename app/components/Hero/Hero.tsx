  ...
  return (
    <div className={container}>
      <div className={inner}>
        ...
        <p>
          Front-end Web Development for delicious web apps.
          Specialised in beautiful, fast, responsive user
          interfaces using maintainable clean code.
        </p>
        <a href="#contact" className="btn btn-hero">Get in touch</a>
      </div>
    </div>
  )
}